...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2023 at 03:14 PM
...
(14, 2, 'sinovac, moderna, aztra zeneca', 3, '2022-04-12 04:19:05', 'null', 'verified'),
(26, 2, 'thx jawabannya', 1, '2022-06-19 02:33:04', 'null', 'null'),
...
--
-- Table structure for table `dokterpraktik`
--
...
--
-- Dumping data for table `dokterpraktik`
--
...
--
-- Table structure for table `jadwalkalori`
--
...
--
-- Dumping data for table `jadwalkalori`
--

INSERT INTO `jadwalkalori` (`id_jadwal`, `id_user`, `id_asupan`, `date`, `waktu`) VALUES
(16, 2, 1, '2022-04-22', 'pagi'),
(17, 2, 11, '2022-04-22', 'siang'),
(18, 2, 3, '2022-04-22', 'siang'),
(19, 2, 4, '2022-04-22', 'malam'),
(20, 2, 7, '2022-04-22', 'pagi'),
(21, 2, 4, '2022-04-25', 'pagi'),
(22, 2, 8, '2022-04-25', 'siang'),
(23, 2, 3, '2022-04-25', 'pagi'),
(24, 2, 2, '2022-04-25', 'siang'),
(25, 2, 12, '2022-04-25', 'siang'),
(26, 2, 10, '2022-04-25', 'siang'),
(27, 2, 11, '2022-04-25', 'malam'),
(29, 2, 3, '2022-04-25', 'malam'),
(30, 2, 1, '2022-04-25', 'malam'),
...
--
-- Table structure for table `kebutuhankalori`
--
...
--
-- Dumping data for table `kebutuhankalori`
--
...
(1, 'Rafi', 'Saran dibuat tampilan dark mode', '2022-04-07 09:31:12'),
(17, 'Leonardho R. Sitanggang', 'Tingkatkan lagi performa websitenya', '2022-08-17 20:12:29');
...
(2, '1234567890123456', 'Bogor', '2001-09-12', 'Bumi Panyawangan', 'Programmer', 183, 85, 'Pria', 'Muhammad Rafi Alfarisi', 'rafialfarisi', 'rafialfarisi12092001@gmail.com', '081234567890', 'Rafi1209', 'user_rafialfarisi'),
...
--
-- Table structure for table `relasiobatpenyakit`
--
...
--
-- Dumping data for table `relasiobatpenyakit`
--
...
--
-- Table structure for table `relasipenyakitgejala`
--
...
--
-- Dumping data for table `relasipenyakitgejala`
--
...
--
-- Table structure for table `smartdoc`
--
...
--
-- Dumping data for table `smartdoc`
--
...
--
-- Indexes for table `dokterpraktik`
--
...
--
-- Indexes for table `jadwalkalori`
--
ALTER TABLE `jadwalkalori`
  ADD PRIMARY KEY (`id_jadwal`);

--
-- Indexes for table `kebutuhankalori`
--
...
--
-- Indexes for table `relasiobatpenyakit`
--
ALTER TABLE `relasiobatpenyakit`
  ADD PRIMARY KEY (`id_relasi`);

--
-- Indexes for table `relasipenyakitgejala`
--
...
--
-- AUTO_INCREMENT for table `dokterpraktik`
--
ALTER TABLE `dokterpraktik`
...
--
-- AUTO_INCREMENT for table `jadwalkalori`
--
ALTER TABLE `jadwalkalori`
  MODIFY `id_jadwal` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;

--
-- AUTO_INCREMENT for table `kebutuhankalori`
--
ALTER TABLE `kebutuhankalori`
...
--
ALTER TABLE `masukan`
  MODIFY `id_masukan` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
-- AUTO_INCREMENT for table `relasiobatpenyakit`
--
ALTER TABLE `relasiobatpenyakit`
  MODIFY `id_relasi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `relasipenyakitgejala`
--
ALTER TABLE `relasipenyakitgejala`
...
--
-- AUTO_INCREMENT for table `smartdoc`
--
ALTER TABLE `smartdoc`
